...
set CLOSURE_LIB_SOURCE_DIR=c:\dev\Projects\Misc\picnet-closure-library-fork\closure-library
REM set CLOSURE_COMPILER_SOURCE_DIR=c:\dev\Projects\Misc\picnet_closure_compiler\build\picnetcompiler.jar
...
REM del %CLOSURE_COMPILER_TARGET_DIR%

mklink /D %CLOSURE_LIB_TARGET_DIR% %CLOSURE_LIB_SOURCE_DIR% && ^
REM mklink %CLOSURE_COMPILER_TARGET_DIR% %CLOSURE_COMPILER_SOURCE_DIR%
