...
$re$$inline_13$$.exec($goog$userAgent$getUserAgentString$$()),$version$$inline_12$$=$arr$$inline_15$$?$arr$$inline_15$$[1]:"";if($goog$userAgent$IE$$){var $docMode$$inline_16$$,$doc$$inline_143$$=$goog$global$$.document;$docMode$$inline_16$$=$doc$$inline_143$$?$doc$$inline_143$$.documentMode:$JSCompiler_alias_VOID$$;if($docMode$$inline_16$$>parseFloat($version$$inline_12$$)){$goog$userAgent$VERSION$$=""+$docMode$$inline_16$$;break a}}$goog$userAgent$VERSION$$=$version$$inline_12$$}
...
$JSCompiler_prototypeAlias$$.$resetList$=function $$JSCompiler_prototypeAlias$$$$resetList$$($list$$1$$){this.list=$list$$1$$;this.$initialiseControlCaches$()};
$JSCompiler_prototypeAlias$$.$initialiseFilters$=function $$JSCompiler_prototypeAlias$$$$initialiseFilters$$(){this.$filterKey$=(this.list.getAttribute("id")||this.list.getAttribute("name")||"")+"_"+ ++$picnet$ui$filter$GenericListFilter$filteridx$$+"_filters";this.$initialiseControlCaches$();$JSCompiler_StaticMethods_registerListenersOnFilters$$(this);var $additionalFilterStates$$inline_84_filterState$$inline_79$$=this.options.enableCookies&&$goog$net$cookies$$.get(this.$filterKey$);if($additionalFilterStates$$inline_84_filterState$$inline_79$$){for(var $additionalFilterStates$$inline_84_filterState$$inline_79$$=
$additionalFilterStates$$inline_84_filterState$$inline_79$$.split("|"),$additionalStates$$inline_85_states$$inline_80$$=[],$additionalFilterValueCookieId$$inline_83_i$$inline_81$$=0;$additionalFilterValueCookieId$$inline_83_i$$inline_81$$<$additionalFilterStates$$inline_84_filterState$$inline_79$$.length;$additionalFilterValueCookieId$$inline_83_i$$inline_81$$++){var $additionalState$$inline_86_state$$inline_82$$=$additionalFilterStates$$inline_84_filterState$$inline_79$$[$additionalFilterValueCookieId$$inline_83_i$$inline_81$$].split(",");
$additionalStates$$inline_85_states$$inline_80$$.push(new $picnet$ui$filter$FilterState$$($additionalState$$inline_86_state$$inline_82$$[0],$additionalState$$inline_86_state$$inline_82$$[3],parseInt($additionalState$$inline_86_state$$inline_82$$[1],10),$additionalState$$inline_86_state$$inline_82$$[2]))}$JSCompiler_StaticMethods_applyFilterStates$$(this,$additionalStates$$inline_85_states$$inline_80$$,$JSCompiler_alias_TRUE$$)}if($additionalFilterValueCookieId$$inline_83_i$$inline_81$$=this.options.additionalFilterValueCookieId)if($additionalFilterStates$$inline_84_filterState$$inline_79$$=
this.options.enableCookies&&$goog$net$cookies$$.get($additionalFilterValueCookieId$$inline_83_i$$inline_81$$)){$additionalFilterStates$$inline_84_filterState$$inline_79$$=$additionalFilterStates$$inline_84_filterState$$inline_79$$.split("|");$additionalStates$$inline_85_states$$inline_80$$=[];for($additionalFilterValueCookieId$$inline_83_i$$inline_81$$=0;$additionalFilterValueCookieId$$inline_83_i$$inline_81$$<$additionalFilterStates$$inline_84_filterState$$inline_79$$.length;$additionalFilterValueCookieId$$inline_83_i$$inline_81$$++)$additionalState$$inline_86_state$$inline_82$$=
$additionalFilterStates$$inline_84_filterState$$inline_79$$[$additionalFilterValueCookieId$$inline_83_i$$inline_81$$].split(","),$additionalStates$$inline_85_states$$inline_80$$.push(new $picnet$ui$filter$FilterState$$($additionalState$$inline_86_state$$inline_82$$[0],$additionalState$$inline_86_state$$inline_82$$[3],parseInt($additionalState$$inline_86_state$$inline_82$$[1],10),$additionalState$$inline_86_state$$inline_82$$[2]));$JSCompiler_StaticMethods_applyFilterStates$$(this,$additionalStates$$inline_85_states$$inline_80$$,
$JSCompiler_alias_TRUE$$)}};
...
$JSCompiler_prototypeAlias$$.refresh=function $$JSCompiler_prototypeAlias$$$refresh$(){this.$cancelQuickFind$=$JSCompiler_alias_FALSE$$;clearTimeout(this.$lastTimerID$);var $filterStates$$=this.$getFilterStates$();$JSCompiler_StaticMethods_applyFilterStates$$(this,$filterStates$$,$JSCompiler_alias_FALSE$$);if(this.options.enableCookies){for(var $val$$inline_90$$=[],$additionalFilter$$inline_91$$=[],$additionalFilterValueCookieId$$inline_92$$=$JSCompiler_alias_NULL$$,$i$$inline_93$$=0;$i$$inline_93$$<
$filterStates$$.length;$i$$inline_93$$++){var $state$$inline_94$$=$filterStates$$[$i$$inline_93$$],$val$$inline_90$$=$JSCompiler_StaticMethods_addFilterStateToStringArray$$($val$$inline_90$$,$state$$inline_94$$),$additionalFilterValueCookieId$$inline_92$$=this.options.additionalFilterValueCookieId;if(this.options.additionalFilterTriggers&&$additionalFilterValueCookieId$$inline_92$$)for(var $j$$inline_95$$=0;$j$$inline_95$$<this.options.additionalFilterTriggers.length;$j$$inline_95$$++)$state$$inline_94$$.id===
this.options.additionalFilterTriggers[$j$$inline_95$$].getAttribute("id")&&($additionalFilter$$inline_91$$=$JSCompiler_StaticMethods_addFilterStateToStringArray$$($additionalFilter$$inline_91$$,$state$$inline_94$$))}$goog$net$cookies$$.set(this.$filterKey$,$val$$inline_90$$.join(""),999999);this.options.additionalFilterTriggers&&$additionalFilterValueCookieId$$inline_92$$&&$goog$net$cookies$$.set($additionalFilterValueCookieId$$inline_92$$,$additionalFilter$$inline_91$$.join(""),999999)}};
...
$JSCompiler_prototypeAlias$$.$getFilterStateForFilter$=function $$JSCompiler_prototypeAlias$$$$getFilterStateForFilter$$($filter$$1$$){var $type$$77$$=$filter$$1$$.options?"select-one":$filter$$1$$.getAttribute("type"),$value$$70$$;switch($type$$77$$){case "text":$value$$70$$=$filter$$1$$.value===$JSCompiler_alias_NULL$$?$JSCompiler_alias_NULL$$:$filter$$1$$.value.toLowerCase();break;case "select-one":$value$$70$$=0===$filter$$1$$.selectedIndex?$JSCompiler_alias_NULL$$:$filter$$1$$.options[$filter$$1$$.selectedIndex].value;
break;case "checkbox":$value$$70$$=$filter$$1$$.checked;break;default:$JSCompiler_alias_THROW$$("Filter type "+$type$$77$$+" is not supported")}return $value$$70$$===$JSCompiler_alias_NULL$$||0>=$value$$70$$.length?$JSCompiler_alias_NULL$$:new $picnet$ui$filter$FilterState$$($filter$$1$$.getAttribute("id"),$value$$70$$,0,$type$$77$$)};
...
function $JSCompiler_StaticMethods_getNormalisedSearchTokensForState$$($JSCompiler_StaticMethods_getNormalisedSearchTokensForState$self$$,$state$$4$$){if($state$$4$$===$JSCompiler_alias_NULL$$)return $JSCompiler_alias_NULL$$;switch($state$$4$$.type){case "select-one":return[$state$$4$$.value];case "text":var $JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$;$JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$=$JSCompiler_StaticMethods_getNormalisedSearchTokensForState$self$$.search;
var $matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$state$$4$$.value;if($matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$){var $matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.toLowerCase(),$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$;$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$=
$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.replace(">= ",">=").replace("> ",">").replace("<= ","<=").replace("< ","<").replace("!= ","!=").replace("= ","=");for(var $i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=/([^"^\s]+)\s*|"([^"]+)"\s*/g,$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=[],$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=$JSCompiler_alias_NULL$$;$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=
$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$.exec($exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$);)$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.push($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$[1]||$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$[2]);$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$=[];for($i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=
0;$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$<$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.length;$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$++)$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$[$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$],$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=
$JSCompiler_StaticMethods_normaliseTerm$$($exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$,$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$,"("),$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=$JSCompiler_StaticMethods_normaliseTerm$$($exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$,$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$,")"),0<$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$.length&&
$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.push($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$);$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$;$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$=[];for(var $lastToken$$inline_159_normalisedTokens$$inline_165$$,$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=
0;$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$<$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.length;$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$++)if(($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$[$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$])&&0!==$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$.length)0===
$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$.indexOf("-")&&($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$="not",$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$[$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$]=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$[$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$].substring(1),$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$--),
$lastToken$$inline_159_normalisedTokens$$inline_165$$&&"("!==$lastToken$$inline_159_normalisedTokens$$inline_165$$&&"not"!==$lastToken$$inline_159_normalisedTokens$$inline_165$$&&"and"!==$lastToken$$inline_159_normalisedTokens$$inline_165$$&&"or"!==$lastToken$$inline_159_normalisedTokens$$inline_165$$&&"and"!==$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$&&"or"!==$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$&&")"!==$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$&&
$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.push("and"),$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.push($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$),$lastToken$$inline_159_normalisedTokens$$inline_165$$=$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$;$lastToken$$inline_159_normalisedTokens$$inline_165$$=$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$;
$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$="";$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$=[];for($i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$=0;$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$<$lastToken$$inline_159_normalisedTokens$$inline_165$$.length;$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$++){var $token$$inline_170$$=$lastToken$$inline_159_normalisedTokens$$inline_165$$[$i$$inline_169_match$$inline_180_token$$inline_155_token$$inline_161$$];
if(0!==$token$$inline_170$$.length)if("and"!==$token$$inline_170$$&&"or"!==$token$$inline_170$$&&"not"!==$token$$inline_170$$&&"("!==$token$$inline_170$$&&")"!==$token$$inline_170$$)$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$+"|"+$token$$inline_170$$;else if(0===$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length||"("===$token$$inline_170$$)$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.push($token$$inline_170$$);
else if(")"===$token$$inline_170$$)for($i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.pop();"("!==$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$&&0<$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length;)$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$+
"|"+$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$,$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.pop();else{if("("!==$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$[$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length-1])for(;0!==$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length&&
!("("===$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$[$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length-1]);)if($JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$.$precedences_$[$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$[$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length-1]]>
$JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$.$precedences_$[$token$$inline_170$$])$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$=$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.pop(),$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$+"|"+$i$$inline_154_i$$inline_160_regex$$inline_178_stackOperator$$inline_168$$;
else break;$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.push($token$$inline_170$$)}}for(;0<$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.length;)$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$=$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$+"|"+$exp$$inline_177_newTokens$$inline_158_normalisedTokens$$inline_153_stackOps$$inline_167$$.pop();$JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$=
$matches$$inline_179_postFix$$inline_166_text$$inline_99_tokens$$inline_157$$.substring(1).split("|")}else $JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$=$JSCompiler_alias_NULL$$;return $JSCompiler_StaticMethods_parseSearchTokens$self$$inline_98_JSCompiler_inline_result$$97$$;case "checkbox":return $JSCompiler_alias_NULL$$;default:$JSCompiler_alias_THROW$$("State type "+$state$$4$$.type+" is not supported")}}
...
$JSCompiler_prototypeAlias$$.$doesElementContainText$=function $$JSCompiler_prototypeAlias$$$$doesElementContainText$$($state$$5$$,$item$$2$$,$textTokens$$1$$,$optText_text$$inline_173$$){var $JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=$state$$5$$!=$JSCompiler_alias_NULL$$&&"select-one"===$state$$5$$.type;$optText_text$$inline_173$$||($optText_text$$inline_173$$=$goog$string$trim$$($goog$dom$getTextContent$$($item$$2$$)));if($JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=$JSCompiler_StaticMethods_doesTextMatchTokens$$($optText_text$$inline_173$$,
$textTokens$$1$$,$JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$))this.options.matchingElement?($JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=$item$$2$$,window.jQuery&&($JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=window.jQuery($item$$2$$)),$JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=this.options.matchingElement($state$$5$$,$JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$,$textTokens$$1$$)):
$JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$=$JSCompiler_alias_TRUE$$;return $JSCompiler_temp$$141_JSCompiler_temp$$2_exact_object$$inline_109$$};
...
$goog$dom$getElementsByTagNameAndClass_$$("td",$JSCompiler_alias_NULL$$,$tdCells_trTableRow$$),$thead$$=$goog$dom$createDom$$("thead",$JSCompiler_alias_NULL$$),$parent$$inline_111_tr$$=this.list;$parent$$inline_111_tr$$.insertBefore($thead$$,$parent$$inline_111_tr$$.childNodes[0]||$JSCompiler_alias_NULL$$);$parent$$inline_111_tr$$=$goog$dom$createDom$$("tr",$JSCompiler_alias_NULL$$);$thead$$.appendChild($parent$$inline_111_tr$$);for(var $i$$87$$=0;$i$$87$$<$tdCells_trTableRow$$.length;$i$$87$$++){var $th$$=
$goog$dom$createDom$$("th",$JSCompiler_alias_NULL$$);$th$$.innerHTML="col"+$i$$87$$;$parent$$inline_111_tr$$.appendChild($th$$)}this.$thead$=$thead$$}$picnet$ui$filter$TableFilter$$.$superClass_$.$initialiseFilters$.call(this)};
...
function $JSCompiler_StaticMethods_buildFiltersRow$$($JSCompiler_StaticMethods_buildFiltersRow$self$$){if(!(0<$goog$dom$getElementsByTagNameAndClass_$$("tr","filters",$JSCompiler_StaticMethods_buildFiltersRow$self$$.$thead$).length)){for(var $tr$$2$$=$goog$dom$createDom$$("tr",{"class":"filters"}),$i$$88$$=0;$i$$88$$<$JSCompiler_StaticMethods_buildFiltersRow$self$$.headers.length;$i$$88$$++){var $element$$inline_125_filterType$$inline_123_header$$2_td$$1$$=$JSCompiler_StaticMethods_buildFiltersRow$self$$.headers[$i$$88$$],
$filterClass_visible$$="none"!=$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$.style.display;if($filterClass_visible$$){var $JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$="false"===$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$.getAttribute("filter")||!$filterClass_visible$$?"":$goog$dom$getTextContent$$($element$$inline_125_filterType$$inline_123_header$$2_td$$1$$),$filterClass_visible$$=$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$.getAttribute("filter-class");
if($JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$&&0<$JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$.length){var $filter$$3$$;a:{var $JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$=$JSCompiler_StaticMethods_buildFiltersRow$self$$,$colIdx$$inline_121$$=$i$$88$$,$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$=$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$.getAttribute("filter-type")||"text";switch($element$$inline_125_filterType$$inline_123_header$$2_td$$1$$){case "text":$filter$$3$$=
$goog$dom$createDom$$("input",{type:"text",id:"filter_"+$colIdx$$inline_121$$,"class":"filter",title:$JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$.options.filterToolTipMessage});break a;case "ddl":$filter$$3$$=$JSCompiler_StaticMethods_getSelectFilter$$($JSCompiler_StaticMethods_getFilterDom$self$$inline_120_headerText$$,$colIdx$$inline_121$$);break a;default:$JSCompiler_alias_THROW$$("filter-type: "+$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$+" is not supported")}}$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$=
$filter$$3$$;$goog$isString$$("width")?$goog$style$setStyle_$$($element$$inline_125_filterType$$inline_123_header$$2_td$$1$$,"95%","width"):$goog$object$forEach$$("width",$goog$partial$$($goog$style$setStyle_$$,$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$));$element$$inline_125_filterType$$inline_123_header$$2_td$$1$$=$goog$dom$createDom$$("td",$JSCompiler_alias_NULL$$,$filter$$3$$)}else $element$$inline_125_filterType$$inline_123_header$$2_td$$1$$=$goog$dom$createDom$$("td",{},"");
$filterClass_visible$$&&$goog$dom$classes$add$$($element$$inline_125_filterType$$inline_123_header$$2_td$$1$$,$filterClass_visible$$);$tr$$2$$.appendChild($element$$inline_125_filterType$$inline_123_header$$2_td$$1$$)}}$JSCompiler_StaticMethods_buildFiltersRow$self$$.$thead$.appendChild($tr$$2$$)}}
...
function($td$$2_txt$$1$$){($td$$2_txt$$1$$=$goog$string$trim$$($goog$dom$getTextContent$$($td$$2_txt$$1$$)))&&!("&nbsp;"===$td$$2_txt$$1$$||0<=$goog$array$indexOf$$($values$$7$$,$td$$2_txt$$1$$))&&$values$$7$$.push($td$$2_txt$$1$$)});$values$$7$$.sort();$goog$array$forEach$$($values$$7$$,function($child$$inline_134_txt$$2$$){$child$$inline_134_txt$$2$$=$goog$dom$createDom$$("option",{value:$child$$inline_134_txt$$2$$.replace('"',"&#034;")},$child$$inline_134_txt$$2$$);$select$$.appendChild($child$$inline_134_txt$$2$$)});
return $select$$}
...
$JSCompiler_prototypeAlias$$.$getFilterStateForFilter$=function $$JSCompiler_prototypeAlias$$$$getFilterStateForFilter$$($JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$){var $state$$8$$=$picnet$ui$filter$TableFilter$$.$superClass_$.$getFilterStateForFilter$.call(this,$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$);if($state$$8$$){$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$=$goog$dom$getAncestorByTagNameAndClass$$($JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$,"TD");
if(!$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$||0>=$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$.length)$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$=-1;else var $filterRow$$inline_139$$=$goog$dom$getAncestorByTagNameAndClass$$($JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$,"TR"),$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$=$goog$array$indexOf$$($filterRow$$inline_139$$.cells,$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$);
$state$$8$$.$idx$=$JSCompiler_inline_result$$136_filter$$4_filterCell$$inline_138$$}return $state$$8$$};
$JSCompiler_prototypeAlias$$.$doesElementContainText$=function $$JSCompiler_prototypeAlias$$$$doesElementContainText$$($state$$9$$,$tr$$3$$,$textTokens$$5$$){var $cells$$2$$=$tr$$3$$.getElementsByTagName("td"),$columnIdx_txt$$3$$=$state$$9$$===$JSCompiler_alias_NULL$$?-1:$state$$9$$.$idx$;if(0>$columnIdx_txt$$3$$){for(var $columnIdx_txt$$3$$=[],$i$$90$$=0;$i$$90$$<$cells$$2$$.length;$i$$90$$++){var $header$$5$$=this.headers[$i$$90$$];"none"!=$header$$5$$.style.display&&"false"!==$header$$5$$.getAttribute("filter")&&
