...
function $JSCompiler_StaticMethods_applyStateToElements$$($JSCompiler_StaticMethods_applyStateToElements$self$$,$filterState$$1$$){var $normalisedTokens$$3$$=$JSCompiler_StaticMethods_getNormalisedSearchTokensForState$$($JSCompiler_StaticMethods_applyStateToElements$self$$,$filterState$$1$$);if($normalisedTokens$$3$$)for(var $i$$85$$=0;$i$$85$$<$JSCompiler_StaticMethods_applyStateToElements$self$$.$listItems$.length&&!$JSCompiler_StaticMethods_applyStateToElements$self$$.$cancelQuickFind$;$i$$85$$++){var $item$$=
$JSCompiler_StaticMethods_applyStateToElements$self$$.$listItems$[$i$$85$$];$item$$.getAttribute("filtermatch")||$JSCompiler_StaticMethods_applyStateToElements$self$$.$doesElementContainText$($filterState$$1$$,$item$$,$normalisedTokens$$3$$)||$item$$.setAttribute("filtermatch","false")}}
